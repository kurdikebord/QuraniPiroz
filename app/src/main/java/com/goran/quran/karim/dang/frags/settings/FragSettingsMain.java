...
package com.goran.quran.karim.dang.frags.settings;
...
import static com.goran.quran.karim.dang.reader_managers.ReaderParams.READER_STYLE_PAGE;
import static com.goran.quran.karim.dang.reader_managers.ReaderParams.READER_STYLE_TRANSLATION;
import static com.goran.quran.karim.dang.utils.app.DownloadSourceUtils.DOWNLOAD_SRC_DEFAULT;
import static com.goran.quran.karim.dang.utils.app.DownloadSourceUtils.DOWNLOAD_SRC_GITHUB;
import static com.goran.quran.karim.dang.utils.app.DownloadSourceUtils.DOWNLOAD_SRC_JSDELIVR;
import static com.goran.quran.karim.dang.utils.reader.ReaderTextSizeUtils.TEXT_SIZE_MIN_PROGRESS;
import static com.goran.quran.karim.dang.utils.reader.ReaderTextSizeUtils.getMaxProgress;
import static com.goran.quran.karim.dang.utils.univ.Codes.SETTINGS_LAUNCHER_RESULT_CODE;
import static com.goran.quran.karim.dang.utils.univ.Keys.READER_KEY_SAVE_TRANSL_CHANGES;
import static com.goran.quran.karim.dang.utils.univ.Keys.READER_KEY_SETTING_IS_FROM_READER;
import static com.goran.quran.karim.dang.utils.univ.Keys.READER_KEY_TRANSL_SLUGS;
...
import com.goran.quran.karim.dang.api.models.recitation.RecitationTranslationInfoModel;
import com.goran.quran.karim.dang.api.models.tafsir.TafsirInfoModel;
import com.goran.quran.karim.dang.databinding.FragSettingsMainBinding;
import com.goran.quran.karim.dang.databinding.LytReaderIndexTabBinding;
import com.goran.quran.karim.dang.databinding.LytReaderSettingsItemBinding;
import com.goran.quran.karim.dang.databinding.LytReaderSettingsItemSwitchBinding;
import com.goran.quran.karim.dang.databinding.LytReaderSettingsTextDecoratorBinding;
import com.goran.quran.karim.dang.databinding.LytReaderSettingsTextSizeBinding;
import com.goran.quran.karim.dang.databinding.LytResDownloadSourceSheetBinding;
import com.goran.quran.karim.dang.databinding.LytSettingsLayoutStyleBinding;
import com.goran.quran.karim.dang.databinding.LytSettingsReaderBinding;
import com.goran.quran.karim.dang.databinding.LytSettingsVotdToggleBinding;
import com.goran.quran.karim.dang.databinding.LytThemeExplorerBinding;
import com.goran.quran.karim.dang.frags.settings.appLogs.FragSettingsAppLogs;
import com.goran.quran.karim.dang.frags.settings.recitations.FragSettingsRecitations;
import com.goran.quran.karim.dang.frags.settings.recitations.manage.FragSettingsManageAudio;
import com.goran.quran.karim.dang.reader_managers.ReaderVerseDecorator;
import com.goran.quran.karim.dang.utils.app.DownloadSourceUtils;
import com.goran.quran.karim.dang.utils.app.ThemeUtils;
import com.goran.quran.karim.dang.utils.extensions.ContextKt;
...
import com.goran.quran.karim.dang.utils.reader.QuranScriptUtils;
import com.goran.quran.karim.dang.utils.reader.QuranScriptUtilsKt;
import com.goran.quran.karim.dang.utils.reader.ReaderTextSizeUtils;
import com.goran.quran.karim.dang.utils.reader.TranslUtils;
import com.goran.quran.karim.dang.utils.reader.factory.QuranTranslationFactory;
import com.goran.quran.karim.dang.utils.reader.recitation.RecitationManager;
import com.goran.quran.karim.dang.utils.reader.recitation.RecitationUtils;
import com.goran.quran.karim.dang.utils.reader.tafsir.TafsirManager;
import com.goran.quran.karim.dang.utils.sharedPrefs.SPAppConfigs;
import com.goran.quran.karim.dang.utils.sharedPrefs.SPReader;
import com.goran.quran.karim.dang.utils.sharedPrefs.SPVerses;
import com.goran.quran.karim.dang.utils.simplified.SimpleSeekbarChangeListener;
import com.goran.quran.karim.dang.utils.simplified.SimpleTabSelectorListener;
import com.goran.quran.karim.dang.utils.tafsir.TafsirUtils;
import com.goran.quran.karim.dang.utils.univ.Keys;
import com.goran.quran.karim.dang.utils.votd.VOTDUtils;
import com.goran.quran.karim.dang.views.BoldHeader;
import com.goran.quran.karim.dang.widgets.IconedTextView;
import com.goran.quran.karim.dang.widgets.bottomSheet.PeaceBottomSheet;
import com.goran.quran.karim.dang.widgets.bottomSheet.PeaceBottomSheetParams;
...
public class FragSettingsMain extends FragSettingsBase implements FragmentResultListener {
    ...
    private void initManageAudioExplorer(LinearLayout parent) {
        com.goran.quran.karim.dang.databinding.LytReaderSettingsItemBinding mManageAudioExplorerBinding = LytReaderSettingsItemBinding.inflate(
            mInflater);
