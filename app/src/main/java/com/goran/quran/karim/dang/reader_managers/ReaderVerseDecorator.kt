...
import com.goran.quran.karim.dang.utils.extensions.getDimension
import com.goran.quran.karim.dang.utils.extensions.getFont
import com.goran.quran.karim.dang.utils.reader.getQuranScriptFontRes
import com.goran.quran.karim.dang.utils.reader.getQuranScriptVerseTextSizeMediumRes
import com.goran.quran.karim.dang.utils.reader.isKFQPCScript
import com.goran.quran.karim.dang.utils.reader.toKFQPCFontFilename
...
class ReaderVerseDecorator(private val ctx: Context) {
    ...
    private val fontTranslationKurdishAlike by lazy { ctx.getFont(R.font.font_kurdi) }
