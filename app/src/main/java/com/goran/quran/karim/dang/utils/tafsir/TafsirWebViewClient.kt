...
import com.goran.quran.karim.dang.utils.univ.ResUtils.getBitmapInputStream
    ...
    private fun handleRequest(view: WebView, request: WebResourceRequest): WebResourceResponse? {
        ...
        when (host) {
            ...
            "assets-font" -> {
                ...
                } else if (uriStr.contains("content") && TafsirUtils.isKurdish(activity.tafsirKey)) {
                    data = view.context.resources.openRawResource(+R.font.font_kurdi)
                }
            }
            "assets-image" -> {
