...
import static com.goran.quran.karim.dang.components.quran.QuranMeta.canShowBismillah;
...
import static com.goran.quran.karim.dang.reader_managers.ReaderParams.RecyclerItemViewType.BISMILLAH;
import static com.goran.quran.karim.dang.reader_managers.ReaderParams.RecyclerItemViewType.CHAPTER_TITLE;
import static com.goran.quran.karim.dang.reader_managers.ReaderParams.RecyclerItemViewType.IS_VOTD;
import static com.goran.quran.karim.dang.reader_managers.ReaderParams.RecyclerItemViewType.NO_TRANSL_SELECTED;
import static com.goran.quran.karim.dang.reader_managers.ReaderParams.RecyclerItemViewType.READER_PAGE;
import static com.goran.quran.karim.dang.reader_managers.ReaderParams.RecyclerItemViewType.VERSE;
import static com.goran.quran.karim.dang.utils.IntentUtils.INTENT_ACTION_OPEN_READER;
import static com.goran.quran.karim.dang.utils.quran.QuranUtils.doesVerseRangeEqualWhole;
import static com.goran.quran.karim.dang.utils.univ.Keys.READER_KEY_CHAPTER_NO;
import static com.goran.quran.karim.dang.utils.univ.Keys.READER_KEY_JUZ_NO;
import static com.goran.quran.karim.dang.utils.univ.Keys.READER_KEY_PENDING_SCROLL;
import static com.goran.quran.karim.dang.utils.univ.Keys.READER_KEY_READER_STYLE;
import static com.goran.quran.karim.dang.utils.univ.Keys.READER_KEY_READ_TYPE;
...
import static com.goran.quran.karim.dang.utils.univ.Keys.READER_KEY_VERSES;
...
import com.goran.quran.karim.dang.adapters.ADPQuranPages;
import com.goran.quran.karim.dang.adapters.ADPReader;
import com.goran.quran.karim.dang.components.quran.Quran;
...
import com.goran.quran.karim.dang.components.quran.subcomponents.Translation;
import com.goran.quran.karim.dang.components.quran.subcomponents.Verse;
import com.goran.quran.karim.dang.components.reader.ChapterVersePair;
import com.goran.quran.karim.dang.components.reader.QuranPageModel;
import com.goran.quran.karim.dang.components.reader.QuranPageSectionModel;
import com.goran.quran.karim.dang.components.reader.ReaderRecyclerItemModel;
import com.goran.quran.karim.dang.databinding.ActivityReaderBinding;
import com.goran.quran.karim.dang.db.readHistory.ReadHistoryDBHelper;
import com.goran.quran.karim.dang.reader_managers.Navigator;
import com.goran.quran.karim.dang.reader_managers.ReaderParams;
import com.goran.quran.karim.dang.suppliments.ReaderLayoutManager;
...
import com.goran.quran.karim.dang.utils.reader.recitation.player.RecitationPlayerParams;
import com.goran.quran.karim.dang.utils.services.RecitationService;
import com.goran.quran.karim.dang.utils.sharedPrefs.SPReader;
import com.goran.quran.karim.dang.utils.thread.runner.CallableTaskRunner;
import com.goran.quran.karim.dang.utils.thread.tasks.BaseCallableTask;
import com.goran.quran.karim.dang.utils.univ.Codes;
import com.goran.quran.karim.dang.utils.univ.Keys;
import com.goran.quran.karim.dang.utils.verse.VerseUtils;
import com.goran.quran.karim.dang.views.reader.verseSpinner.VerseSpinnerItem;
import com.goran.quran.karim.dang.views.readerSpinner2.adapters.VerseSelectorAdapter2;
import com.goran.quran.karim.dang.views.recitation.RecitationPlayer;
