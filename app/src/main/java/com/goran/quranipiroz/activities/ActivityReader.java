...
import static com.goran.quranipiroz.reader_managers.ReaderParams.READER_STYLE_PAGE;
import static com.goran.quranipiroz.reader_managers.ReaderParams.READER_STYLE_TRANSLATION;
import static com.goran.quranipiroz.reader_managers.ReaderParams.RecyclerItemViewType.BISMILLAH;
import static com.goran.quranipiroz.reader_managers.ReaderParams.RecyclerItemViewType.CHAPTER_TITLE;
import static com.goran.quranipiroz.reader_managers.ReaderParams.RecyclerItemViewType.IS_VOTD;
import static com.goran.quranipiroz.reader_managers.ReaderParams.RecyclerItemViewType.NO_TRANSL_SELECTED;
import static com.goran.quranipiroz.reader_managers.ReaderParams.RecyclerItemViewType.READER_PAGE;
import static com.goran.quranipiroz.reader_managers.ReaderParams.RecyclerItemViewType.VERSE;
import static com.goran.quranipiroz.utils.quran.QuranUtils.doesVerseRangeEqualWhole;
import static com.goran.quranipiroz.utils.receivers.RecitationPlayerReceiver.ACTION_NEXT_VERSE;
import static com.goran.quranipiroz.utils.receivers.RecitationPlayerReceiver.ACTION_PLAY_CONTROL;
import static com.goran.quranipiroz.utils.receivers.RecitationPlayerReceiver.ACTION_PREVIOUS_VERSE;
import static com.goran.quranipiroz.utils.univ.Keys.READER_KEY_CHAPTER_NO;
import static com.goran.quranipiroz.utils.univ.Keys.READER_KEY_JUZ_NO;
import static com.goran.quranipiroz.utils.univ.Keys.READER_KEY_PENDING_SCROLL;
import static com.goran.quranipiroz.utils.univ.Keys.READER_KEY_READER_STYLE;
import static com.goran.quranipiroz.utils.univ.Keys.READER_KEY_READ_TYPE;
...
import static com.goran.quranipiroz.utils.univ.Keys.READER_KEY_VERSES;
import static com.goran.quranipiroz.utils.univ.RegexPattern.VERSE_RANGE_PATTERN;
...
import com.goran.quranipiroz.components.quran.Quran;
...
import com.goran.quranipiroz.components.reader.QuranPageModel;
import com.goran.quranipiroz.components.reader.QuranPageSectionModel;
...
import com.goran.quranipiroz.reader_managers.Navigator;
import com.goran.quranipiroz.reader_managers.ReaderParams;
import com.goran.quranipiroz.suppliments.ReaderLayoutManager;
import com.goran.quranipiroz.utils.quran.QuranUtils;
import com.goran.quranipiroz.utils.reader.factory.ReaderFactory;
import com.goran.quranipiroz.utils.reader.recitation.RecitationParams;
import com.goran.quranipiroz.utils.reader.recitation.RecitationUtils;
import com.goran.quranipiroz.utils.receivers.RecitationPlayerReceiver;
...
import com.goran.quranipiroz.views.reader.VerseView;
import com.goran.quranipiroz.views.reader.verseSpinner.VerseSpinnerItem;
import com.goran.quranipiroz.views.readerSpinner2.adapters.VerseSelectorAdapter2;
