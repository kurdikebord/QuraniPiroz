...
import com.goran.quranipiroz.activities.ActivityEditShare
...
object ReaderFactory {
     ...
     * which will be used in [ShortcutUtils][com.goran.quranipiroz.utils.others.ShortcutUtils], because shortcut uses
